...
<form id="myForm" onsubmit ="return Mismatch()" method="post" action="/Register" style="display: none">
    <div class="container">
        ...
        <div class="pad">
            ...
            <input type="checkbox" onclick="ShowPass1()">Show Password <br>
            <button onclick="PassStrength()"> see password strength </button>
        ...
        <div class="pad">
            ...
            <input type="checkbox" onclick="ShowPass2()">Show Password<br><br>
        </div>
        ...
        <div class="pad">
            <label for="start" name="Birthdate">*Date :</label>
        ...
        <div id="student" style="display: none">
            ...
            <div class="pad">
                ...
                <input type="number" name="Student_id" maxlength="12" minlength="12"><br><br>
            </div>
            ...
            <div class="pad">
                ...
                <input type="date" id="start2" name="Student_id_from_date"
                       value="2016-01-01"
            ...
            <div class="pad">
                ...
                <input type="date" id="expiration" name="Student_id_to_date"
                       value="2023-01-01"
        ...
        <div class="pad">
            ...
            <input type="url" id="personal url" name="Personalpage">
        </div>
        ...
        <div class="pad">
            ...
            <input type="number" name="Telephone" placeholder="Phone" size="10" minlength="10" maxlength="14"> <br></br>
        </div>
